...
<table>
  <tr>
    <td align="center" width="33%">
      <strong>IEMOCAP 4-way</strong><br>
      <code>84.7 w.F1</code><br>
      <sub>Best overall · +0.2 pp</sub>
    </td>
    <td align="center" width="33%">
      <strong>IEMOCAP 6-way</strong><br>
      <code>71.9 w.F1</code><br>
      <sub>Tied for best overall</sub>
    </td>
    <td align="center" width="33%">
      <strong>MELD</strong><br>
      <code>68.8 w.F1</code><br>
      <sub>Best overall · +1.6 pp</sub>
    </td>
  </tr>
</table>
...
| Evidence | Key result |
|---|---|
| **Training objectives** | MMAE + NACL achieves the best transfer performance: **84.65 / 71.91 w.F1** on IEMOCAP 4-way / 6-way. |
| **Efficiency** | NACL-only retains the same **4.13M parameters** as CLIP while improving transfer performance. |
| **Representation alignment** | NACL substantially increases Linear CKA and reduces the between-modal representation gap. |
...
<table border="0">
  <tr>
    <td align="center">
      <img src="imgs/modality_alignment.png" alt="Aligned multimodal embeddings under different pretraining objectives" width="100%">
      <br>
      <em>Aligned multimodal embeddings under different MELD pretraining objectives.</em>
    </td>
  </tr>
</table>
...
<table border="0">
  <tr>
    <td align="center">
      <img src="imgs/cd_IEMOCAP_4.png" alt="Cross-modal class-distribution consistency on IEMOCAP 4-way" width="100%">
      <br>
      <em>Cross-modal class-distribution consistency on IEMOCAP 4-way.</em>
    </td>
    <td align="center">
      <img src="imgs/cd_IEMOCAP_6.png" alt="Cross-modal class-distribution consistency on IEMOCAP 6-way" width="100%">
      <br>
      <em>Cross-modal class-distribution consistency on IEMOCAP 6-way.</em>
    </td>
  </tr>
</table>
